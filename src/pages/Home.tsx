...
const getAppUrl = () => {
  if (typeof window !== "undefined") {
    ...
    if (
      ...
      return "https://dev.app.zerogo.ai";
    }
  }
  return "https://app.zerogo.ai";
};
      ...
      <header className="sticky top-0 z-50 border-b border-neutral-100 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden flex-1 items-center justify-center gap-8 text-sm font-medium text-black md:flex">
            ...
            <Link to="/blog" className="transition hover:opacity-70">블로그</Link>
          </nav>

          <div className="flex flex-1 items-center justify-end gap-4">
            <a href={APP_URL} className="rounded-full bg-brand px-5 py-2.5 text-sm font-semibold text-white transition hover:opacity-90">
              무료로 시작하기
            </a>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="mx-auto mt-6 max-w-4xl text-base sm:text-xl lg:text-[18pt] leading-relaxed text-black/80">
                쿠팡 Wing과 엑셀을 오가며 계산하지 않아도 됩니다.<br />
                오늘 발주할 상품과 추천 수량을 우선순위로 정리합니다.
              </p>
              <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:mt-10 sm:flex-row sm:gap-4">
                <a href={APP_URL} className="group inline-flex w-full sm:w-auto items-center justify-center rounded-full bg-brand px-6 py-3.5 text-base sm:px-8 sm:py-4 sm:text-lg font-semibold text-white transition hover:opacity-90">
                  오늘 발주할 상품 확인하기
            ...
            <div className="relative overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900/30 p-8 text-center shadow-2xl sm:p-16">
              ...
              <div className="relative z-10 flex flex-col items-center">
                ...
                <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/70 sm:text-lg">
                  다음 품절은 재고 숫자를 못 봐서가 아니라 발주 타이밍을 놓쳐서 발생합니다.<br />
